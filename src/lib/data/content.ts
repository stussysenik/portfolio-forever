...
export const profile: Profile = {
  name: 'Stüssy Senik',
  taglines: [
    { lang: 'en', text: 'Experience Design Engineer' },
    { lang: 'de', text: 'Kreativtechnologe & Digitaler Handwerker' },
    { lang: 'ja', text: 'クリエイティブ・テクノロジスト' },
  ],
  shortBio: 'Building at the intersection of code, cinema, and computation.',
...
export const works: Entry[] = [
  { year: 2025, month: 12, title: 'untangle your problem 🍝', links: [{ label: 'say spaghetti', url: 'https://uyr-problem.vercel.app' }], category: 'technology', tools: ['JavaScript', 'WebGL'] },
  { year: 2025, month: 12, title: 'infinite checklist ✅', links: [{ label: 'todo', url: 'https://infinite-checklist.vercel.app' }], category: 'technology' },
  { year: 2025, month: 12, title: "clean typewriter experience", links: [{ label: 'tic tac', url: 'https://clean-writer.vercel.app' }], category: 'art' },
  { year: 2025, month: 12, title: "creative block application", links: [{ label: 'sh*t', url: 'https://creative-block.vercel.app' }], category: 'art' },
  { year: 2025, month: 12, title: "b-boy filter", links: [{ label: 'link', url: 'https://bboy-filter.vercel.app' }], featured: 'green', category: 'art' },
  { year: 2025, month: 12, title: "CAD editor in the web", links: [{ label: 'link', url: 'https://1985-cad.vercel.app' }], category: 'art' },
  { year: 2024, month: 11, title: 'physics 213 - magnetism visualizations', links: [{ label: 'url', url: 'https://ph213.vercel.app' }], featured: 'green', category: 'technology' },
  { year: 2025, month: 2, title: 'dvd', links: [{ label: 'link', url: 'https://dvd-video-animation.vercel.app' }], category: 'technology', tools: ['Three.js', 'WebGL'] },
  // { year: 2025, month: 9, title: '13kb-404', links: [{ label: 'link', url: '#' }, { label: 'tweet', url: '#' }], category: 'technology' },
...
export const talks: Entry[] = [
  { year: 2024, month: 12, title: 'I don not have a stage in mind', links: [{ label: 'info', url: '#' }] },
...
export const interviews: Entry[] = [
  { year: 2015, month: 8, title: 'wtf', links: [{ label: 'link', url: '#' }] },
